    ...
    <>
      ...
      <Section sectionRef={homeRef} className='h-screen flex flex-col justify-center items-center' id='home'>
        <div className="terminal container w-fit">
          ...
          <div className="bg-[#1F1F1F] px-5 md:px-10 py-8 text-2xl md:text-4xl rounded-b-xl">
            ...
            <ol className="opacity-75">
              ...
              <li className="transition-all duration-300 ease-in-out hover:translate-x-4">{'>'} <Link className="hover:underline"
                href="src/assets/Siddharth Resume.pdf" download>5.Download Resume</Link>
              </li>
            </ol>
          </div>
        </div>
        <div className="flex mt-6">
          ...
          <Link href="https://github.com/sd8capricon" target="_blank" className="mr-7">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="h-5 w-5"
              viewBox="0 0 16 16">
              <path
          ...
          <Link href="#" target="_blank" className="mr-7">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="h-5 w-5"
              viewBox="0 0 16 16">
              <path
